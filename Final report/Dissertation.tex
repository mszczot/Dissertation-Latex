...
\chapter{Literature \& Technical Review} \label{section:literatureReview}
\input{./literatureReview.tex} 

\chapter{Analysis} \label{section:analysis}
\input{./analysis.tex}
...
\input{./testing/stableresults.tex}

\input{./testing/preferredresults.tex}
%\begin{subappendices}
